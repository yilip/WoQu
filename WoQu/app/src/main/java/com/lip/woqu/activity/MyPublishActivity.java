...
public class MyPublishActivity extends EFragmentActivity implements View.OnClickListener {
    ...
    private MyListView.MainScrollUpDownListener scrolListener = new MyListView.MainScrollUpDownListener() {
        ...
        public void onScrollUpDown(int type) {
            if (scrollUpDownListener != null && listHeight >= minHeight) {
                UtilsManager.println("liheng--->listHeight:" + listHeight);
                UtilsManager.println("liheng--->minHeight:"+minHeight);
    ...
    private void initView() {
        ...
        titleTV.setText(getResources().getString(R.string.my_publish));
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    params.addParam("userId", SysParams.userId+"");
                    String result= NetManager.getInstance().doGetAsString(SysParams.MYPUBLISH_URL,params);
                    Log.d("Result:", result);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 0:
                    ...
                    if (myAdapter == null) {
                        myAdapter = new ActivityListAdapter(MyPublishActivity.this,new ActivityListBean(0,0,activityList),0);
                ...
                case 2:
                    ...
                    if (activityList != null && activityList.size() != 0) {
                        UtilsManager.Toast(MyPublishActivity.this, getString(R.string.net_error));
                        return;
                    }
                    errNetView.show();
