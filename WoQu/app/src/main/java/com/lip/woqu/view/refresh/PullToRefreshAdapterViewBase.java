...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    private OnBaseScrollListener onBaseScrollListener;
    ...
    /**
     * 设置上拉后显示tips提示
     * @param motionless true只显示,text在pull过程中无变化,默认false
     * */
    public void setFooterLayoutMode(boolean motionless, String[] stringArray) {
        getFooterLayout().setDisplayMode(motionless, stringArray);
    }
    ...
    public final void setOnBaseScrollListener(OnBaseScrollListener listener) {
        onBaseScrollListener = listener;
    }
