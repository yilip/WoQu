...
public class PullToRefreshListView extends
        PullToRefreshAdapterViewBase<MyListView> {

	// private LoadingLayout headerLoadingView;
	// private LoadingLayout footerLoadingView;

	class InternalListView extends MyListView implements EmptyViewMethodAccessor {
	...
	protected final MyListView createRefreshableView(Context context,
		...
		// context.getStrinyg(R.string.pull_to_refresh_refreshing_label);
		// String releaseLabel =
		...
		lv.setSelector(R.drawable.blank);
